...
export default function LinkCard({imageSrc, cardLink, cardText, cardTitle}: LinkCardProps){
    ...
    return(
      <Link href={cardLink} className='relative w-[20vw] bg-stone-950 z-1 border border-2 rounded-md border-stone-950'>
        <div className="text-5xl font-semibold font-stretch-ultra-expanded text-shadow-sm text-shadow-red-950/20">{cardTitle}</div>
